...
Nous avons choisi de partir sur notre première idée, donc notre projet consiste à la réalisation d'une carte interactive des AOP Françaises avec le module Shiny avec pour objectif de pouvoir la déposé sur leur serveur et ainsi la rendre accessible à tous via son URL.
...
Pour chaque fonction de shiny, nous avons utilisé en premier lieu la page officiel de la fonction sur le site de Posit [@posit_shiny_nodate].
